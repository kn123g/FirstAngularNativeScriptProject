import { AfterContentInit, ChangeDetectorRef, ElementRef, OnChanges, OnDestroy, QueryList, Renderer2 } from '@angular/core';
...
export declare class NSRouterLinkActive implements OnChanges, OnDestroy, AfterContentInit {
    ...
    constructor(router: Router, element: ElementRef, renderer: Renderer2, cdr: ChangeDetectorRef, link?: NSRouterLink);
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDef<NSRouterLinkActive, [null, null, null, null, { optional: true; }]>;
